...
def search():
  ...
  if len(tag) >= 1 :
    similar_images=es.search_similar_images_tags("image-index-combination",feature_vector[1],tag,num_images)
  else :
    similar_images=es.search_similar_images("image-index-combination",feature_vector[1],num_images)
